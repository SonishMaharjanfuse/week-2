...
DEPARTMENT) VALUES
(001, 'Monika', 'Arora', 100000, '14-02-20 09.00.00',
'HR'),
...
SELECT FIRST_NAME, POSITION('a' IN BINARY FIRST_NAME) FROM Worker WHERE FIRST_NAME = 'Amitabh';
...
-- Q-7. Write an SQL query to print the DEPARTMENT from Worker table after removing white
...
SELECT * FROM Worker WHERE DEPARTMENT = 'Managers';

-- Q-25. Write an SQL query to fetch duplicate records having matching data in some fields of a
-- table.
SELECT; 
...
SELECT * FROM Worker LIMIT (SELECT ROUND(COUNT(*) * .5)  FROM Worker) ;

-- Q-40. Write an SQL query to fetch the departments that have less than five people in it
SELECT *, COUNT(*) AS TOT_PEOPLE FROM Worker w GROUP BY DEPARTMENT HAVING TOT_PEOPLE<5;

-- Q-41. Write an SQL query to show all departments along with the number of people in there.
SELECT *, COUNT(*) AS TOTAL_PEOPLE FROM Worker w GROUP BY DEPARTMENT;

-- Q-42. Write an SQL query to show the last record from a table.
SELECT * FROM Worker w ORDER BY WORKER_ID DESC LIMIT 1;

-- Q-43. Write an SQL query to fetch the first row of a table.
SELECT * FROM Worker LIMIT 1;

-- Q-44. Write an SQL query to fetch the last five records from a table.
SELECT * FROM Worker w LIMIT 5;

-- Q-45. Write an SQL query to print the name of employees having the highest salary in each
-- department.
SELECT *, MAX(SALARY) FROM Worker w GROUP BY DEPARTMENT ;

-- Q-46. Write an SQL query to fetch three max salaries from a table.
SELECT * FROM Worker w ORDER BY SALARY DESC LIMIT 3;

-- Q-47. Write an SQL query to fetch three min salaries from a table.
SELECT * FROM Worker w ORDER BY SALARY ASC LIMIT 3;


-- Q-48. Write an SQL query to fetch nth max salaries from a table.
-- Q-49. Write an SQL query to fetch departments along with the total salaries paid for each of
-- them.
-- Q-50. Write an SQL query to fetch the names of workers who earn the highest salary.
SELECT FiRST_NAME, LAST_NAME FROM Worker w ORDER BY SALARY DESC LIMIT 1;
